<?php
	...
	$rc_url='https://restcountries.eu/rest/v2/alpha/' . $_REQUEST['name'];
	...
	$rc_output['status']['description'] = "mission saved";
    ...
    $ow_url='https://api.openweathermap.org/data/2.5/onecall?lat=' . $rc_output['data']['latlng'][0] . '&lon=' . $rc_output['data']['latlng'][1] . '&exclude=hourly,minutely&units=metric&appid=' . $ow_api_key;
	...
	$ow_output['status']['description'] = "mission saved";
